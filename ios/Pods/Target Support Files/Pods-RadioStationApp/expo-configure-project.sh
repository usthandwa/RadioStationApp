...
with_node \
  ...
  --target "/Users/Zanele/App4RadioV0/public/RadioStationApp/ios/Pods/Target Support Files/Pods-RadioStationApp/ExpoModulesProvider.swift" \
  --platform "apple" \
  --packages "expo-application" "expo-asset" "expo-av" "expo-background-fetch" "expo-constants" "expo-dev-launcher" "expo-dev-menu" "expo-eas-client" "expo-file-system" "expo-font" "expo-keep-awake" "expo-router" "expo-sharing" "expo-system-ui" "expo-updates" "expo-web-browser"
