...
const PodcastsScreen: React.FC = () => {
  ...
  useEffect(() => {
    const podcastData: Podcast[] = [
      { 
        id: '9001', 
        name: 'Valley of Praise', 
        iframeHtml: '<iframe src="https://iframe.iono.fm/c/9001?background=c0cacb&accent=07477B" width="100%" height="450" frameborder="0" referrerpolicy="origin" loading="lazy"></iframe>',
        time: '09:00'
      },
      { 
        id: '7370', 
      ...
      { 
        id: '9017', 
        name: 'The Weekend Chapter', 
        iframeHtml: '<iframe src="https://iframe.iono.fm/c/9017?background=c0cacb&accent=07477B" width="100%" height="450" frameborder="0" referrerpolicy="origin" loading="lazy"></iframe>'
      },
      { 
        id: '8248', 
        name: 'Sinai', 
