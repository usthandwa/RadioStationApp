...
import { usePlaybackState } from '@/services/player/trackPlayerservices';



const IMAGES = {
  listenLive: require('@/assets/Listen_Live.jpg'),
  podcasts: require('@/assets/podcasts.jpg'),
  give: require('@/assets/Give.jpg'),
  prayer: require('@/assets/Prayer.jpg'),
  social: require('@/assets/social.jpg'),
  logo: require('@/assets/awr_sidmedia_logo.png')
};
