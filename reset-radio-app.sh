...
echo "Starting RadioStationApp reset for Expo..."
...
npx create-expo-app@latest RadioStationAppExpo -t expo-template-blank-typescript

# Move the new project files to the current directory
echo "Moving new project files..."
mv RadioStationAppExpo/* .
mv RadioStationAppExpo/.[!.]* .
rmdir RadioStationAppExpo
...
cat > README.md << EOL
# RadioStationApp (Expo version)

This is the Expo version of the RadioStationApp.
...
echo "RadioStationApp reset for Expo complete!"
